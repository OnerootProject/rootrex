...
export class SymbolService {
    ...
    //获取交易对列表
    fetchSymbolList(baseToken: string): Observable<ResponseArrayInterface<SymbolInterface>> {
        return this.http.get<ResponseArrayInterface<SymbolInterface>>(this.api.symbol.getSymbolList.replace("{baseToken}", baseToken));
    }
