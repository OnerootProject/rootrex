...
Datafeeds.DataPulseUpdater = function(datafeed, updateFrequency) {
	...
	if (typeof updateFrequency != 'undefined' && updateFrequency > 0) {
        this._updateInterval = setInterval(update, updateFrequency);
	}
};
...
Datafeeds.UDFCompatibleDatafeed.prototype.disposeUpdateInterval = function () {
    if (this._barsPulseUpdater._updateInterval !== undefined) {
        clearInterval(this._barsPulseUpdater._updateInterval);
    }
};
